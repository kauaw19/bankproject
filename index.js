...
var image = document.getElementById("logo-app-download");
...
toggle.addEventListener("click", function () {
  ...
  if (this.classList.toggle("bi-brightness-high-fill")) {
    ...
    image.src = "svg/Download_on_the_App_Store_Badge_US-UK_RGB_blk_092917.svg";
    ...
    body.style.transition = "2s";
    image.src = "svg/Download_on_the_App_Store_Badge_US-UK_RGB_wht_092917.svg";
